...
//            article_keyword3 = (TextView) itemView.findViewById(R.id.article_keyword3);
    ...
    public ArticleAdapter(Context context, List<ArticleModel> items,int item_layout){
...
//            itemViewHolder.article_keyword1.setText(item.getKeyword1());
//            itemViewHolder.article_keyword2.setText(item.getKeyword2());
//            itemViewHolder.article_keyword3.setText(item.getKeyword3());
            if (item.getImgSrc() != null){
                Glide.with(context).load(item.getImgSrc()).into(itemViewHolder.articleContent);
            }
            else{
                Log.d("getData","equal");
                itemViewHolder.articleTitle.setWidth(ViewGroup.LayoutParams.MATCH_PARENT);
            }
